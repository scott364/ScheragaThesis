...
from asm_tree_cond_test import *
from asm_tree_logic_flow import Run_to_X_Failures_DECO , Negator_DECO
...
class Set_Down_at_Pose( py_trees.composites.Sequence ):
    ...
    def __init__( self , setDownPose , objMinWidth = 0.010 , distAbove = 0.020 , setForce = 2.0 , finalOpen = 1.0 , zSAFE = 0.150 , ctrl = None ):
        super().__init__( name = "Set_Down_at_Pose" , memory = 0 )
        self.ctrl      = ctrl
        self.abovePose = translate_pose( setDownPose , translation_vec = [ 0.0 , 0.0 ,  distAbove ] , dir_pose='origin' )
        self.belowPose = translate_pose( setDownPose , translation_vec = [ 0.0 , 0.0 , -distAbove ] , dir_pose='origin' )
