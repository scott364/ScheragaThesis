...
class SawyerMOD(Manipulator):
    ...
    def __init__(self, robot_name,filelocation, position, orientation=[0,0,0,1], fixed_base=0, publish_full_state=False):
        """
        ...
        super().__init__(robot_name,filelocation, position, orientation, fixed_base)
        ...
        self._init_forward_kinematics(filelocation)
